// You can create your own custom mipmaps to be used when texture pixels are drawn
// depending on distances from the camera and whether the texel needs to be minified or magnified.
