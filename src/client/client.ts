...
renderer1.setSize(200, 200); // hardcoding width and height

const renderer2 = new THREE.WebGLRenderer({ canvas: canvas2 });
renderer2.setSize(200, 200); // hardcoding width and height

const renderer3 = new THREE.WebGLRenderer({ canvas: canvas3 });
renderer3.setSize(200, 200); // hardcoding width and height

const renderer4 = new THREE.WebGLRenderer({ canvas: canvas4 });
renderer4.setSize(200, 200); // hardcoding width and height
...
new OrbitControls(camera1, renderer1.domElement); // can interact using mouse now
