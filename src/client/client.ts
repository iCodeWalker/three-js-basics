...
//--- Displacement map alters the height of the geometry and vertices rather than changing the color.

//------- A displacement map is an image that can be used to alter the geometry of a mesh.
//-------  The value of each pixel is used to change the position of the vertices of the mesh.

//-------  When using a displacement map, ensure that the geometry of the mesh that you are using, e.g.,
//-------  a plane, has many vertices. The displacement map is modifying the vertices.
//-------  The more vertices you have, then the more detailed the displacement gets.
const displacementMap = new THREE.TextureLoader().load(
  "img/gebco_bathy.5400x2700_8bit.jpg"
);
material.displacementMap = displacementMap;

// Adding a NormalMap gives a much better result.
...
// This adds more vertices to our plane geometry.
