...
// When mipmapping is enabled (default), the GPU will use different size versions of a texture
// to render a surface depending on how far away it is from the camera.

// Three.js will create different versions of image so it could use it later,
// depending upon the distance from the camera

// This pre-caching greatly improves speed
