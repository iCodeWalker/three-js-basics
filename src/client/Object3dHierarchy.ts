...
// 1. Using add method we can make Object3d a child of another Object3d

// 2.You can also add Object3Ds to other Object3Ds that are already part of the scene.
// Any changes to the Object3D such as position, scale, rotation will affect
// all of the children under the same parent equally.
...
// 3. scene.position.set(0, 0, 0) // this is default position of a scene, and any Object3Ds
...
// cube.add(sphere) // The spheres parent is now the cube.
// The sphere will be x=3 offset from the cube in local space.
// So that will be 8 in world space since the cube is a child of the scene and is already offset x = 5.

// 3. To get World transform values we need to create a vector.
